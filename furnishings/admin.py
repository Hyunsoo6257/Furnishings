...
def dbseed():
    category1 = Category(name='Living', image='Living_main.jpg', \
        description='''Living furniture''')
    category2 = Category(name='Outdoor', image='Outdoor_main.jpg', \
        description='''Outdoor_furniture''')
    category3 = Category(name='Lighting', image='Lighting_main.jpg', \
    ...
    p1 = Product(category_id=category1.id, image='Living_1.jpg', price=59.99,\
    ...
    p2 = Product(category_id=category1.id, image='Living_2.jpg', price=100.50,\
    ...
    p3 = Product(category_id=category1.id, image='Living_3.jpg', price=180.50,\
    ...
    p4 = Product(category_id=category1.id, image='Living_4.jpg', price=99.99,\
    ...
    p5 = Product(category_id=category2.id, image='Outdoor_1.jpg', price=49.00,\
    ...
    p6 = Product(category_id=category2.id, image='Outdoor_2.jpg', price=250.99,\
    ...
    p7 = Product(category_id=category2.id, image='Outdoor_3.jpg', price=120.00,\
    ...
    p8 = Product(category_id=category2.id, image='Outdoor_4.jpg', price=60.00,\
    ...
    p9 = Product(category_id=category3.id, image='Light_1.jpg', price=189.99,\
        date=datetime.datetime(2023, 5, 17),\
    ...
    p10 = Product(category_id=category3.id, image='Light_2.jpg', price=89.95,\
    ...
    p11 = Product(category_id=category3.id, image='Light_3.jpg', price=45.99,\
    ...
    p12 = Product(category_id=category3.id, image='Light_14.jpg', price=49.99,\
